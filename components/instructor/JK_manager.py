            ...
            messages=[
                {
                    ...
                    "content": """
                            ...
                            # 入出力例
                            入力：トレーニングメニュー: スクワット 現在の回数: 3 目標回数: 20 姿勢の状態 完璧
                            出力：すごい！好きになっちゃいそう！その調子だよ！

                            入力：トレーニングメニュー: スクワット 現在の回数: 17 目標回数: 20 姿勢の状態点 完璧
                            出力：ほらあと3回だけ！頑張って！

                            入力：トレーニングメニュー: スクワット 現在の回数: 23 目標回数: 20 姿勢の状態 完璧
                            出力：（きゅんっ...❤）

                            入力：トレーニングメニュー: スクワット 現在の回数: 18 目標回数: 20 姿勢の状態 内股
                            出力：いい調子だよ！でもちょっと内股かな？外に向けてやってみて！
